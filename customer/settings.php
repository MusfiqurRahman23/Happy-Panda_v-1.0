...
*/
//$list13=    $database->query("select * from patient where pemail");
...
$sqlmain= "select * from customer where cemail=?";
            ...
            $stmt->execute();
            $result = $stmt->get_result();
            $userfetch=$userrow=$result->fetch_assoc();
//for ($y=0;$y<$list13->num_rows;$y++){
  //  $userfetch=$list13->fetch_assoc();
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">My Orders</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
